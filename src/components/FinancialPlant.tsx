...
export function FinancialPlant({
  ...
  return (
    <div
      className={cn(
        "relative select-none overflow-hidden rounded-3xl shadow-sm transition-all",
        className,
      )}
      ...
      >
        ...
        {background === "bg_night" ? (
          ...
          <g>
            ...
            <path
              d="M-10 90 C 20 60, 40 80, 50 120 C 20 110, 5 130, -10 140 Z"
              fill="#059669"
              opacity="0.18"
            />
            <path
              d="M170 80 C 140 50, 120 70, 110 110 C 140 100, 155 120, 170 130 Z"
              fill="#059669"
              opacity="0.18"
            />
          </g>
          ...
          <g>
            ...
            <path
              d="M15 170 V 35 C 45 10, 115 10, 145 35 V 170"
              stroke="#0284c7"
              strokeWidth="2"
              opacity="0.25"
              fill="none"
        ...
        <ellipse
          ...
          rx="42"
          ry="7"
          fill={background === "bg_night" ? "#090d16" : "rgba(0,0,0,0.14)"}
        />
        ...
        <g className={wilt ? undefined : "animate-sway"}>
          {isInitialSprout ? (
            ...
            <g
              transform={`translate(80, ${150 - stemHeight * 0.45}) scale(${0.7 + growth * 0.45})`}
            >
              ...
              {Array.from({ length: leafCount }).map((_, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <path
                      d="M 6 -20 L 14 -24 M 8 -32 L 18 -36 M 5 -42 L 12 -46"
                      stroke="#ffffff"
                      strokeWidth="2.5"
                      strokeLinecap="round"
                      opacity="0.8"
            ...
            <g>
              ...
              {Array.from({ length: leafCount }).map((_, i) => {
                ...
                return (
                  <g key={i} className="animate-rise" style={{ animationDelay: `${i * 0.08}s` }}>
                    <ellipse
                      cx={80 + dir * 16 * sc}
                      cy={y}
                      rx={18 * sc}
        ...
        {potStyle === "pot_wood" ? (
          ...
          <g>
            <path
              d="M55 150 L60 120 H100 L105 150 Z"
              fill={`url(#${uid}-pot-wood)`}
              filter={`url(#${uid}-shadow)`}
            />
          ...
          <g>
            <path
              d="M56 150 L58 122 H102 L104 150 Z"
              fill={`url(#${uid}-pot-metal)`}
              filter={`url(#${uid}-shadow)`}
            />
          ...
          <g>
            ...
            {/* Vidrio reflectante */}
            <path
              d="M56 150 L60 122 H100 L104 150 Z"
              fill={`url(#${uid}-pot-crystal)`}
              filter={`url(#${uid}-shadow)`}
          ...
          <g>
            <path
              d="M55 150 L62 120 H98 L105 150 Z"
              fill={`url(#${uid}-pot-cyber)`}
              filter={`url(#${uid}-shadow)`}
            />
            <line
              x1="60"
        ...
        {effect === "fx_petals" ? (
          ...
          <g className="animate-sparkle">
            ...
            <polygon
              points="80,18 82,23 87,24 83,27 84,32 80,29 76,32 77,27 73,24 78,23"
              fill="#facc15"
              opacity="0.85"
            />
          </g>
