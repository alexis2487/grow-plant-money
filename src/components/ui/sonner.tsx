    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          description:
            "group-[.toast]:text-muted-foreground group-[.toast]:text-xs font-normal mt-0.5",
          actionButton:
            "group-[.toast]:bg-primary group-[.toast]:text-primary-foreground group-[.toast]:rounded-xl group-[.toast]:text-xs font-semibold px-3 py-1.5",
          cancelButton:
            "group-[.toast]:bg-muted group-[.toast]:text-muted-foreground group-[.toast]:rounded-xl group-[.toast]:text-xs px-3 py-1.5",
        },
      }}
      {...props}
    />
